...
#
shopt -s extglob
set "${1%%+(C:/xampp/htdocs/gtfw36cop/files/applicant/registulang/docx2txt-1.4/haha/haha/)}"
...
$1 = "C:/xampp/htdocs/gtfw36cop/files/applicant/registulang/docx2txt-1.4/haha/haha/";
TEXTFILE=${1/%.docx/.txt}
