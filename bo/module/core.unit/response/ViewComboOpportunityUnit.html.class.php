...
class ViewComboOpportunityUnit extends HtmlResponse {
    ...
    function ProcessRequest() {
        ...
        Messenger::Instance()->Send('core.unit', 'comboContractUnit', 'view', 'html', $comboData, Messenger::UntilFetched);

        $allowAdd = Security::Authorization()->IsAllowedToAccess('core.unit', 'addUnit', 'view', 'html');

        $list = $ObjUnit->listUnitToOpportunitySummary();
