 ...
 * @author Prima Noor 
 */
class ViewInputSliderBanner extends HtmlResponse {

    function TemplateModule() {
        $this->SetTemplateBasedir(Configuration::Instance()->GetValue('application', 'docroot') . 'module/' . GtfwDispt()->mModule . '/template');
        $this->SetTemplateFile('view_input_sliderbanner.html');
    }
    ...
    function ProcessRequest() {
        ...
        if (!empty($post)) {
            ...
            $input = $ObjSliderBanner->getDetailSliderBanner($id);
        }
    ...
    function ParseTemplate($rdata = NULL) {
        ...
        $this->mrTemplate->addVar('content', 'URL_BACK', GtfwDispt()->GetUrl('cms.slider.banner', 'SliderBanner', 'view', 'html') . '&display');
        $this->mrTemplate->addVar('content', 'URL', GtfwDispt()->GetUrl('cms.slider.banner', (empty($id) ? 'add' : 'update') . 'SliderBanner', 'do', 'json') . '&elmId=' . $elmId);
    }
