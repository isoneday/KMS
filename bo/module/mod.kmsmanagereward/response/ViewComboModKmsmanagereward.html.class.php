...
class ViewComboModKmsmanagereward extends HtmlResponse
{
    function TemplateModule()
    {
        $this->SetTemplateBasedir(Configuration::Instance()->GetValue('application', 'docroot') . 'module/mod.kmsmanagereward/template');
        $this->SetTemplateFile('view_combo_modkmsmanagereward.html');
    }
    ...
    function ProcessRequest()
    {
        ...
        Messenger::Instance()->Send('mod.kmsmanagereward', 'comboModKmsmanagereward', 'view', 'html', $comboData, Messenger::UntilFetched);
        
        $allowAdd = Security::Authorization()->IsAllowedToAccess('mod.kmsmanagereward', 'addModKmsmanagereward', 'view', 'html');
        
        $list = $ObjModKmsmanagereward->listModKmsmanagereward();
    ...
    function ParseTemplate($rdata = null)
    {
        ...
        if (!empty($comboData['elmId'])) {
            ...
            if (!empty($comboData['showAdd']) and $allowAdd) {
                ...
                $this->mrTemplate->addVar('button_add', 'URL', GtfwDispt()->GetUrl('mod.kmsmanagereward', 'addModKmsmanagereward', 'view', 'html').'&elmId='.$comboData['elmId']);
            }
        }
