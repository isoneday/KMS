...
class ViewModKmstraining extends HtmlResponse
{
   	function TemplateModule()
   	{
      	$this->SetTemplateBasedir(Configuration::Instance()->GetValue('application','docroot').'module/'.GtfwDispt()->mModule.'/template');
      	$this->SetTemplateFile('view_modkmstraining.html');
   	}
   	...
   	{	
		...
		$total = $ObjModKmstraining->countModKmstraining($filter);
		$data = $ObjModKmstraining->getModKmstraining($filter);
   ...
   if (!empty($data) AND count($data)>0) {
           ...
           $this->mrTemplate->addVar('item','FILE2', $val['filedata_enc']);
              ...
              $this->mrTemplate->addVar('button_delete', 'URL', GtfwDispt()->GetUrl('mod.kmstraining', 'deleteModKmstraining', 'do', 'json').'&id='.$val['training']);
          
              $this->mrTemplate->addVar('button_detail', 'URL', GtfwDispt()->GetUrl('mod.kmstraining', 'detailModKmstraining', 'view', 'json').'&id='.$val['training']);
                $this->mrTemplate->addVar('button_update', 'URL', GtfwDispt()->GetUrl('mod.kmstraining', 'updateModKmstraining', 'view', 'html').'&id='.$val['training']);
           
                $val['url_detail'] = GtfwDispt()->GetUrl('mod.kmstraining', 'detailModKmstraining', 'view', 'html').'&id='.$val['training'];
        ...
        $this->mrTemplate->addVar('button_add', 'URL', GtfwDispt()->GetUrl('mod.kmstraining', 'addModKmstraining', 'view', 'html'));
    }
}
?>