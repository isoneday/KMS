...
class ViewComboSearchengine extends HtmlResponse
{
    function TemplateModule()
    {
        $this->SetTemplateBasedir(Configuration::Instance()->GetValue('application', 'docroot') . 'module/searchengine/template');
        $this->SetTemplateFile('view_combo_searchengine.html');
    }
    ...
    function ProcessRequest()
    {
        ...
        Messenger::Instance()->Send('searchengine', 'comboSearchengine', 'view', 'html', $comboData, Messenger::UntilFetched);
        
        $allowAdd = Security::Authorization()->IsAllowedToAccess('searchengine', 'addSearchengine', 'view', 'html');
        
        $list = $ObjSearchengine->listSearchengine();
    ...
    function ParseTemplate($rdata = null)
    {
        ...
        if (!empty($comboData['elmId'])) {
            ...
            if (!empty($comboData['showAdd']) and $allowAdd) {
                ...
                $this->mrTemplate->addVar('button_add', 'URL', GtfwDispt()->GetUrl('searchengine', 'addSearchengine', 'view', 'html').'&elmId='.$comboData['elmId']);
            }
        }
