...
class User extends Database {
    ...
    public function insertFilePhoto($params) {
        $res= $this->Execute($this->mSqlQueries['insert_file_photo'], $params);
// echo "<pre>".$this->GetLastError();die();
     return $res;
    }
public function updateFilePhoto($params) {
     $res= $this->Execute($this->mSqlQueries['update_file_photo'], $params);
     // echo "<pre>".$this->GetLastError();die();
     return $res;
    ...
    public function insertUser($params) {
        ...
        $res =$this->Execute($this->mSqlQueries['insert_user'], $params);
    // echo "<pre>".$this->GetLastError();die();
