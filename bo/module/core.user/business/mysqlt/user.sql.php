...
SELECT 
    ...
    u.agama AS `agama`,
    u.posisi_kerja AS 'posisi_kerja',
    ...
    u.user_active_lang_code AS `active_lang_code`,
    u.user_last_logged_in AS `last_logged_in`,
    u.user_last_ip AS `last_ip`,
    ...
    (SELECT zc.photo_path FROM kms_photo zc WHERE zc.photo_userid = u.user_id) AS `filephoto`,     
