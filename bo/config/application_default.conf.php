...
$application['db_conn'][0]['db_host'] = '192.168.254.239';
$application['db_conn'][0]['db_user'] = 'dev';
$application['db_conn'][0]['db_pass'] = 'devPASS';
$application['db_conn'][0]['db_name'] = 'dev_pf_new_beasiswa';
