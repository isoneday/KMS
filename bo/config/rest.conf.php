<?php defined('GTFW_APP_DIR') OR exit('No direct script access allowed');
...
|
*/
$rest['rest_valid_logins'] = array('admin' => '1234');
...
|
| Example: $rest['rest_ip_whitelist'] = '123.456.789.0, 987.654.32.1';
|
