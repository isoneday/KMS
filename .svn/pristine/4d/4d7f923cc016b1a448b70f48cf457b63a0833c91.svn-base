...
class ViewPaging extends JsonResponse
{
    ...
    {
        $this->SetTemplateBasedir(Configuration::Instance()->GetValue('application', 'docroot') . 'module/paging/template');
    ...
    function ProcessRequest()
    {
        ...
        return array('exec' => 'GtfwAjax.replaceContentWithUrl("subcontent-element"," ' . Dispatcher::Instance()->GetUrl('paging', 'Paging', 'view', 'html') . '&ascomponent=1")');
