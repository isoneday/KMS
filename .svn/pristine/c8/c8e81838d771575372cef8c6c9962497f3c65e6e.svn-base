...
(function($){
    $.parser={
        ...
        plugins:["resizable","pagination","tooltip","linkbutton","menubutton","splitbutton","progressbar","tree","combobox","combotree","combogrid","numberbox","validatebox","searchbox","numberspinner","timespinner","calendar","datebox","datetimebox","slider","layout","panel","datagrid","propertygrid","treegrid","accordion","window","dialog"],
        parse:function(_2){
            var aa=[];
...
function _1e9(_1ea){
    $(_1ea).find("div.panel:visible,div.accordion:visible,div.layout:visible").each(function(){
...
$(window).unbind(".panel").bind("resize.panel",function(){
    ...
    TO=setTimeout(function(){
        ...
        if(_20f.length){
            ...
            $("body").children("div.panel,div.accordion,div.layout").triggerHandler("_resize");
        }
        _20e=true;
        TO=false;
    },200);
